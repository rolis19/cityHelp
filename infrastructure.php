...
<html>
<head>
	<title>Infrastructure - Smart City</title>
		...
		<div class="row main-header">
			<div class="hero text-center">
				...
				<div class="categ-menu">
					<a href="infra-city.html">City</a>
					<div class="bullet"></div>
					<a href="infra-transport.html">Transport</a>
					<div class="bullet"></div>
					<a href="infra-general.html">General</a>
					<div class="bullet"></div>
					<a href="infra-all.html">All</a>
				</div>
				<a href="infrastruktur-data.html" class="btn btn-success btn-lg">INFRASTRUCTURE DATA</a>
			</div>
			<div class="user">
				<?php
