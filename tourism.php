...
<body>
<section class="tourism" data-parallax="scroll">
	<div class="container-fluid">
		<div class="row main-header">
			<div class="hero text-center">
				<h1>TOURISM</h1>
				<div class="categ-menu">
					<a href="tourism-event.html">Event</a>
					<div class="bullet"></div>
					<a href="tourism-food.html">Food</a>
					<div class="bullet"></div>
					<a href="tourism-places.html">Places</a>
					<div class="bullet"></div>
					<a href="tourism-places.html">All</a>
				</div>
				<a href="tourism-data.html" class="btn btn-success btn-lg">TOURISM DATA</a>
			</div>
			<div class="user">
				<?php
...
<div class="container main-post	">
	<div class="row">
		<div class="col-md-8">
			<?php
				$query = mysql_query("SELECT * FROM post WHERE post_category='Tourism'");
